 ...
 */
final class Version20250522204453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE report_trip ADD CONSTRAINT FK_57A18C07E5CF884 FOREIGN KEY (report_owner_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE "user" ADD CONSTRAINT FK_8D93D649EFE9B7A6 FOREIGN KEY (driver_preferences_id) REFERENCES driver_preferences (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE user_trip ADD CONSTRAINT FK_CD7B9F2A76ED395 FOREIGN KEY (user_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE "user" DROP CONSTRAINT FK_8D93D649EFE9B7A6');
